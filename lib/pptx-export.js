...
const FONT_MAP = {
  'libre baskerville': 'Georgia', 'cormorant garamond': 'Palatino Linotype',
  'playfair display': 'Georgia', 'source serif 4': 'Palatino Linotype',
  'source serif pro': 'Palatino Linotype', 'merriweather': 'Georgia',
  'lora': 'Palatino Linotype', 'eb garamond': 'Garamond', 'gelasio': 'Georgia',
  'fraunces': 'Georgia', 'roboto slab': 'Rockwell',
  'inter': 'Segoe UI', 'dm sans': 'Segoe UI', 'source sans 3': 'Segoe UI',
  'source sans pro': 'Segoe UI', 'work sans': 'Candara', 'outfit': 'Candara',
  'nunito': 'Trebuchet MS', 'archivo': 'Franklin Gothic Medium',
  'space grotesk': 'Century Gothic', 'cabinet grotesk': 'Century Gothic',
  'clash display': 'Century Gothic', 'satoshi': 'Century Gothic',
  'overpass': 'Segoe UI', 'barlow': 'Segoe UI', 'instrument sans': 'Segoe UI',
  'poppins': 'Segoe UI', 'open sans': 'Segoe UI', 'lato': 'Segoe UI',
  'raleway': 'Trebuchet MS', 'montserrat': 'Trebuchet MS', 'roboto': 'Segoe UI',
  'prompt': 'Trebuchet MS', 'kanit': 'Trebuchet MS',
  'jetbrains mono': 'Consolas', 'fira code': 'Consolas',
  'source code pro': 'Consolas', 'inconsolata': 'Consolas',
  'courier new': 'Courier New',
};
const CATEGORY_FALLBACKS = {
  serif: 'Georgia', 'sans-serif': 'Segoe UI', monospace: 'Consolas',
  cursive: 'Segoe UI', fantasy: 'Trebuchet MS', 'system-ui': 'Segoe UI',
};
